...
class TG {
    ...
    public $token = '1754326106:AAF8LFoliaFRY9COd2J5bm0qaxNGumzoUAk';
  
    public function __construct($token) {
        $this->token = $token; 
    }
      
    public function send($id, $message, $kb, $kbbottom='') {
        $data = array(
            'chat_id' => $id,
            'text'  => $message,
            'parse_mode' => 'HTML',
        ...
        if($kbbottom) {
           $data['reply_markup']=json_encode(array('keyboard' => $kbbottom, "resize_keyboard" => true));
        }
