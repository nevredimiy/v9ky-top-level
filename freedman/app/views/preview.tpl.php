...
<section class="controls">
    <div class="controls__container">
        ...
        <div class="preview">
            ...
            <?php endif ?>
            <?php if(!empty($video[0]['videobest'])): ?>
            <div class="preview__item">
                <div class="video-container">
                    <div class="placeholder videoPlaceholder">
                        Загрузка відео...
            ...
            <?php endif ?>
            <?php if(!empty($video[0]['video_intervu'])): ?>
            <div class="preview__item">
                <div class="video-container">
                    <div class="placeholder videoPlaceholder">
                        Загрузка відео...
            ...
            <?php endif ?>
            <?php if(!empty($video[0]['video_intervu2'])): ?>
            <div class="preview__item">
                <div class="video-container">
                    <div class="placeholder videoPlaceholder">
                        Загрузка відео...
